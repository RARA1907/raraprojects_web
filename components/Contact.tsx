        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="font-[family-name:var(--font-outfit)] text-[#666] leading-relaxed mb-10 max-w-md">
              Tell us about your business and we&apos;ll get back to you within 24 hours with a plan and a quote.
            </p>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <div className="font-[family-name:var(--font-outfit)] text-white text-sm group-hover:text-white transition-colors">
                    WhatsApp
                  </div>
                  <div className="font-[family-name:var(--font-outfit)] text-[#555] text-xs">
                    +90 535 480 0478
                  </div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <div className="font-[family-name:var(--font-outfit)] text-white text-sm">
                    Email
                  </div>
                  <div className="font-[family-name:var(--font-outfit)] text-[#555] text-xs">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="font-[family-name:var(--font-outfit)] text-xs text-[#555] mb-2 block">
                  Name
                </label>
                <input
                  type="text"
            ...
            <button
              type="submit"
              className="w-full bg-white text-black font-[family-name:var(--font-outfit)] font-medium py-3 rounded-full hover:bg-[#e0e0e0] transition-colors text-sm"
            >
              Send message
            </button>
          </form>
